             ...
             <li class="nav-item">
                 ...
                 <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                     <div class="bg-white py-2 collapse-inner rounded">
                         ...
                         <a class="collapse-item" href="../admin/riwayat-medis.php">Riwayat Medis</a>
                     </div>
                 </div>
             </li>
              ...
              <!-- form start -->
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="nama" value="<?= $hasil['nama_pasien']?>"readonly>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Umur Pasien</label>
                    <input type="text" class="form-control" name="umur" value="<?= $hasil['umur']?>" readonly>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Keluhan</label>
                    <input type="text" class="form-control" name="keluhan" value="<?= $hasil['keluhan']?>" readonly>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Resep Atau Obat</label>
                    <input type="text" class="form-control" name="keluhan" value="<?= $hasil['resepobat']?>" readonly>
                  </div>
            </div>
            </div>
